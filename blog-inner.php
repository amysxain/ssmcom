...
<div class="col-md-9 col-xs-12 mtop-10 pull-right">
  ...
  <h1 class="main-head h3 nm-top">Here is the ultimate reading list summer 2016 Elevate Your Listening With</h1>
		<p class="date no-margin-top"><strong class="pclr">Body decor</strong> - Aug 1, 2016</p>
...
Debuting in 2016 is Wonambi &ndash; a dynamic, thrilling water ride that sends a four-person raft into high speed, near-vertical, zero gravity moments designed to let riders experience an unparalleled feeling of weightlessness. Raging Waves is conveniently located just minutes from the Aurora Outlet Mall, check out complete schedule and info at www.ragingwaves.com</p>
         ...
         <h3 class="main-head h4 m30top">Heading More</h3>
...
<ul class="bulleted filter">
	...
	<ul class="relate-post ">
      ...
      <img class="media-object img-responsive" src="images/blog-1.jpg" alt="...">
			...
			<div class="relate-post-content"> <h4 class="media-heading">Here is the ultimate reading list summer 2016</h4>
