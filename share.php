...
<main class="main">
   ...
   <p class="text-left">Share your coupons and promotional codes with other smart shoppers to help them save money at popular online stores.
...
<p class="radiobtn"><label for="radio1"><input type="radio" name="promoCode" checked="checked" id="radio1" data-id="opt1" selected><span><i class="fa fa-check"></i> I have a printable coupon</span></label></p>
...
<p class="radiobtn"><label for="radio2"><input type="radio" name="promoCode" id="radio2" data-id="opt2">
...
<p class="radiobtn"><label for="radio3"><input type="radio" name="promoCode" id="radio3" data-id="opt3">
...
<input type="text" class="input-trans form-control" placeholder="Enter a printable coupon"></p>
